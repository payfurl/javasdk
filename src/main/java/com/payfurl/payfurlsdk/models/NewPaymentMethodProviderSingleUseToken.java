...
public class NewPaymentMethodProviderSingleUseToken {
    ...
    @JsonCreator
    public NewPaymentMethodProviderSingleUseToken(
    ...
    public static class Builder {
        ...
        public NewPaymentMethodProviderSingleUseToken build() {
            return new NewPaymentMethodProviderSingleUseToken(providerId, providerToken, providerTokenData, metadata);
        }
    }
}
